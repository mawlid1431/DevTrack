      ...
      <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
        ...
        <div>
          ...
          <SectionHeading
            ...
            lede="DevTrack's agent works inside your workspace with org-scoped tools — it files issues, summarizes cycles, drafts standups, and catches duplicates before they ship."
          />
